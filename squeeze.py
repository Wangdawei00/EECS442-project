...
class Decoder_block(nn.Module):
    ...
    def forward(self, x, skip_connection):
        up_sampler = nn.Upsample(size=tuple(skip_connection.size()[2:4]),
...
class Decoder(nn.Module):
    def __init__(self, encoder_out=512, skip=256):
        super().__init__()

        # TODO
        # squeeze
        """
        2 torch.Size([5, 64, 239, 319])
        5 torch.Size([5, 128, 119, 159])
        8 torch.Size([5, 256, 59, 79])
        13 torch.Size([5, 512, 29, 39])
        """
        ...
        self.conv3 = nn.Conv2d(b3_out, 1, kernel_size=3, stride=1, padding=1)

    def forward(self, features):
        # TODO
        # squeeze
        conv1, pool1, pool2, encoder_output = features[
            2], features[5], features[8], features[13]

        encoder_output = self.conv2(F.relu(encoder_output))

        b1_output = self.block1(encoder_output, pool2)
        b2_output = self.block2(b1_output, pool1)
        b3_output = self.block3(b2_output, conv1)
        # b4_output = self.block4(b3_output, conv1)

        depth = self.conv3(b3_output)
...
class Squeeze(nn.Module):
    ...
    def forward(self, x):
        ...
        uper = nn.Upsample(size=(240, 320), mode='bilinear',
                           align_corners=True)
        depth = uper(depth)
        return depth
...
8 torch.Size([5, 256, 59, 79])
13 torch.Size([5, 512, 29, 39])
feature1: 0             torch.Size([5, 64, 239, 319])
feature2: 1             torch.Size([5, 64, 239, 319])
feature3: 2             torch.Size([5, 64, 119, 159])
feature4: 3             torch.Size([5, 128, 119, 159])
feature5: 4             torch.Size([5, 128, 119, 159])
feature6: 5             torch.Size([5, 128, 59, 79])
feature7: 6             torch.Size([5, 256, 59, 79])
feature8: 7             torch.Size([5, 256, 59, 79])
feature9: 8             torch.Size([5, 256, 29, 39])
feature10: 9            torch.Size([5, 384, 29, 39])
feature11: 10           torch.Size([5, 384, 29, 39])
feature12: 11           torch.Size([5, 512, 29, 39])
feature13: 12           torch.Size([5, 512, 29, 39])
torch.Size([5, 768, 59, 79])
torch.Size([5, 384, 119, 159])
torch.Size([5, 192, 239, 319])

...
https://github.com/pranjaldatta/DenseDepth-Pytorch/blob/master/densedepth/losses.py
"""
...
def ssim_loss(img1, img2, val_range, window_size=11, window=None, size_average=True, full=False):
...
# Now we define the actual gradient loss function
# def gradient_loss(y_pred, y_true, device="cuda"):
